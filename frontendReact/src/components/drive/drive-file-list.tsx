            ...
            {items.map((item) => {
                ...
                return (
                    <button
                        ...
                        className="flex items-center gap-3 w-full rounded-xl px-2.5 py-2.5 text-left border border-transparent hover:bg-background hover:border-border hover:shadow-sm transition-all group"
                    >
